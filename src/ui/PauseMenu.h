...
struct InterfaceSettings { int uiScaleIndex = 2; bool showHud = true, showCrosshair = true, showPhysicsStats = false, drawPath = false, objectInfo = true, objectInfoMaterial = false, objectInfoVelocity = true, objectInfoMass = true, objectInfoRadius = true, objectInfoAngularSpeed = false, objectInfoBodyType = false; bool operator==(const InterfaceSettings&) const = default; };
